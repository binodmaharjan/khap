...
@section('content')
    ...
    <form class="form-horizontal" role="form" method="POST" action="{{ route('admin_gallery_update') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <textarea name="desc" cols="50" rows="10" class="form-control" value="{{ old('desc') }}" >{{$report->desc}}</textarea>
