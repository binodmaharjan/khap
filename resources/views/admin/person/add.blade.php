...
@section('content')
    ...
    <form class="form-horizontal" role="form" method="POST" action="{{ isset($person)? route('admin.persons.store.family', $person->id): route('admin.persons.store') }}" enctype="multipart/form-data">
        {!! csrf_field() !!}
        ...
        <div class="form-group{{ $errors->has('name_np') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="name_np" type="text" class="form-control" name="name_np" value="{{ old('name_np') }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="email" type="text" class="form-control" name="address" value="{{ old('address') }}" required autofocus>
        ...
        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="health" type="text" class="form-control" name="health" value="{{ old('phone') }}" required autofocus>
